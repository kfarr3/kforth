...
int fn_time(_kforth_context *context)
{
	STACK_PUSH(platform_time(NULL));
	return 0;
}
...
const _word_entry_const entry_time					={	&entry_get,						"time",		(void*)fn_time,					   	NULL };

const _word_entry_const entry_mod                   ={  &entry_time,                    "mod",      (void*)fn_mod,                     	NULL };
const _word_entry_const entry_minus                 ={  &entry_mod,                     "-",        (void*)fn_minus,                   	NULL };
const _word_entry_const entry_plus                  ={  &entry_minus,                   "+",        (void*)fn_plus,                    	NULL };
const _word_entry_const entry_mul                   ={  &entry_plus,                    "*",        (void*)fn_mul,                     	NULL };
